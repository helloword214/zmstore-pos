...
import { deleteWorkforceScheduleAppendEventHistoryPathArtifacts } from "./workforce-schedule-append-event-history-path-setup";
...
async function main() {
  ...
  console.log(
    [
      "Workforce schedule append event history path cleanup complete.",
    ...
    .catch((error) => {
      console.error(
        error instanceof Error
          ? error.message
          : "Unknown workforce schedule append event history cleanup error.",
      );
      throw error;
    })
    .finally(async () => {
