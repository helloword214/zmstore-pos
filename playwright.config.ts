...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "cashier-shift-waive-info-only-path",
      testMatch: /cashier\/cashier-shift-waive-info-only-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "delivery-manager-shortage-review-charge-path",
      testMatch:
        /delivery\/delivery-manager-shortage-review-charge-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "delivery-final-settlement-gating",
      testMatch: /delivery\/delivery-final-settlement-gating\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "delivery-final-settlement-info-only-waive-path",
      testMatch:
        /delivery\/delivery-final-settlement-info-only-waive-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "product-photo-upload-happy-path",
      testMatch: /product\/product-photo-upload-happy-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "workforce-schedule-template-assignment-happy-path",
      testMatch:
        /workforce\/workforce-schedule-template-assignment-happy-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "workforce-schedule-planner-assignment-gating-path",
      testMatch:
        /workforce\/workforce-schedule-planner-assignment-gating-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "workforce-schedule-published-row-maintenance-path",
      testMatch:
        /workforce\/workforce-schedule-published-row-maintenance-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
    ...
    {
      name: "workforce-schedule-append-event-history-path",
      testMatch:
        /workforce\/workforce-schedule-append-event-history-path\.spec\.ts/,
      use: {
        ...devices["Desktop Chrome"],
        viewport: { width: 1366, height: 900 },
      },
