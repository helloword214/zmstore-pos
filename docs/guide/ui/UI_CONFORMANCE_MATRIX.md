...
| `app/routes/store.dispatch.tsx` | Dispatch queue | PARTIAL | REMIT | SoT dropdown controls now cover list sort + run assignment, but title/pill usage is not fully standardized | section hierarchy can be tighter | P2 |
